	...
	return (
		<>
			<p>
				<b>
					{
						"Are you looking for comprehensive technical and professional support in your software career? "
					}
				</b>
				{
			...
			<p>
				<b>{"What resources do we offer? "}</b>
				{
					"We develop and organize free resources, events, and support for professionals to hone their technical skills; develop and find their authentic professional voice; and collaborate with their peers on software projects:"
				}
			</p>
			<ul>
				<li>
